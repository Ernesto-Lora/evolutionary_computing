...
for i = 1:num_runs
    ...
    filename = sprintf('experiment_results_2/run_%02d.mat', i);
...
title('Convergence Plot of Median Experiment in Algorithm 2', 'FontSize', 14);
...
exportgraphics(gcf, 'plot2.pdf', 'ContentType', 'vector');
